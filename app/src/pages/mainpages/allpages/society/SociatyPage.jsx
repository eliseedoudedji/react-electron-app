...
import { faEye, faArchive , faEdit, faTrash, faEllipsisH } from '@fortawesome/free-solid-svg-icons';

const DropdownMenu = ({ isOpen, onClose, buttonRef }) => {
                                ...
                                <div className="col-xl-12">
                                    <div className="card custom-card">
                                        <div className="card-body" >
                                            ...
                                            <div className="table-responsive" style={{ maxHeight: '500px', overflowY: 'auto', position: 'relative' }}>
