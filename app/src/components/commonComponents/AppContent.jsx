...
import face11 from '../../pages/mainpages/assets/images/faces/11.jpg'
            ...
            <div className="p-3 header-secondary row">
                <div className="col">
                    <div className="d-flex">
                        <a className="btn btn-danger d-flex" href="#">
                ...
                <div className="col col-auto">
                    <div className="btn-list">
                        ...
                        <a className="btn btn-success me-0" href="#">
                            <i className="fe fe-plus me-1 mt-1" />
                            Add New
                        </a>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-6 col-xxl-3">
                        <div className="card custom-card">
                            ...
                            <div className="card-footer">
                                <span className="text-start">
                                    <i className="fe fe-dollar-sign  text-success me-1" /> 22% Profits
                                </span>
                                <span className="float-end">
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="mt-1">
                                                <h6 className="mb-1 fs-14">
                                                    James Paig
                                                    <span className="fw-normal text-muted">Updated</span> New
                                                    project
                                                </h6>
                            ...
                            <div className="card-body">
                                <div className="mb-3">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="mt-1">
                                            <h6 className="mb-1 font-weight-semibold fs-14">Ui Update</h6>
                                            <span className="clearfix" />
                            ...
                            <div className="card-body">
                                <ul className="list-group list-item-spacing1">
                                    ...
                                    <li className="list-group-item px-0 d-sm-flex align-items-center border-0">
                                        ...
                                        />
                                        <div className="ms-sm-3 flex-grow-1">
                                            <h6 className="fw-senibold mb-0 mt-1 fs-14">George Lujan</h6>
                                    ...
                                    <li className="list-group-item px-0  d-sm-flex align-items-center border-0">
                                        ...
                                        />
                                        <div className="ms-sm-3 flex-grow-1">
                                            <h6 className="fw-senibold mb-0 mt-1 fs-14">Lujan arijan</h6>
                                            <span className="text-muted">Founder</span>
                                            <a href="" className="text-primary tx-13">
                                                Reply
                                            </a>
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="text-center">
                                                        <span className="btn btn-outline-info btn-sm">96%</span>
                                                    </div>
                                                </td>
                                                <td className="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="text-center">
                                                        <span className="btn btn-outline-info btn-sm">49%</span>
                                                    </div>
                                                </td>
                                                <td className="text-center">
                                                    <span className="badge badge-sm rounded-pill bg-success-transparent text-success">
